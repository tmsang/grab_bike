package com.intec.grab.bike_driver.utils.auth;
...
public class OAuth implements Interceptor {
    ...
    private IAccessTokenListener accessTokenListener;

    public OAuth(OkHttpClient client, TokenRequestBuilder tokenRequestBuilder) {
    ...
    private void setFlow(OAuthFlow flow) {
        switch(flow) {
            case accessCode:
            case implicit:
    ...
    public void registerAccessTokenListener(IAccessTokenListener accessTokenListener) {
