...
public class CertUtils {
    ...
    public static Certificate parseCertificate(String cert) {
        try {
            ...
            return certificateFactory.generateCertificate(CommonHelper.stringToInputStream(cert));
        } catch (Exception e) {
    ...
    private static TrustManager[] certToTrustManager(String cert) throws GeneralSecurityException {
        ...
        Collection<? extends Certificate> certificates =
                certificateFactory.generateCertificates(CommonHelper.stringToInputStream(cert));
